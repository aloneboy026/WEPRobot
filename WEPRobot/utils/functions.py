...
from WEPRobot import aiohttpsession as aiosession
from WEPRobot.ex_plugins.dbfunctions import start_restart_stage
from WEPRobot.utils.http import get, post
...
def generate_captcha():
    ...
    height = 100
    correct_answer = ""
    font = ImageFont.truetype("WEPRobot/resources/default.ttf", 55)
    file = f"WEPRobot/resources/{randint(1000, 9999)}.jpg"
