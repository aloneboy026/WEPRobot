...
from WEPRobot import pbot as app 
from WEPRobot import arq
from WEPRobot.services.keyboard import Ikb
from WEPRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from WEPRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from WEPRobot.services.types import InlineQueryResultCachedDocument
from WEPRobot.modules.info import get_chat_info, get_user_info
from WEPRobot.modules.music import download_youtube_audio
from WEPRobot.utils.functions import test_speedtest
from WEPRobot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://graph.org/file/32a94e912f02da0db4a3d.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/WEP_Robot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[WEP_Robot 🔥](https://graph.org/file/32a94e912f02da0db4a3d.jpg):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [Owner](t.me/ll_Mahadev_ll) 
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    ...
    group_invite = "https://t.me/Girls_Talking_Group"
    try:
        messages = [
            m
