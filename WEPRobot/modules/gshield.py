...
from WEPRobot.confing import get_int_key, get_str_key
from WEPRobot.services.telethonbasics import is_admin
from WEPRobot.events import register
from pymongo import MongoClient
from WEPRobot.modules.sql.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from WEPRobot import telethn as tbot, MONGO_DB_URI, BOT_ID
